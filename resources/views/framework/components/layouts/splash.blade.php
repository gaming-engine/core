...
<head>
    ...
    <script type="text/javascript" src="{{ mix('/public/js/manifest.js', 'modules/framework/') }}"></script>
    <script type="text/javascript" src="{{ mix('/public/js/vendor.js', 'modules/framework/') }}" defer></script>
    <script type="text/javascript" src="{{ mix('/public/js/app.js', 'modules/framework/') }}" defer></script>
</head>
...
<div id="app">
    <component :is="'layout'">
        <nav class="bg-white shadow">
                ...
                <div class="flex justify-between h-16">
                    <div class="flex px-2 lg:px-0">
                        <div class="flex-shrink-0 flex items-center">
                            <x-ge:c-logo class="h-8 w-auto pt-2"/>
                        </div>
            ...
            <div class="lg:hidden" :class="{hidden: !collapsed}">
            ...
            <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
                ...
                <div class="mt-8 md:mt-0 md:order-1">
                    <p class="text-center text-base leading-6 text-gray-400">
                        © {{ date('Y') }} {{ $siteConfiguration->name }}. All rights
                        reserved.</p>
                </div>
            </div>
        </div>
